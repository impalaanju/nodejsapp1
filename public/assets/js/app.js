var AppProcess = (function(){
    ...
    var rtp_aud_senders = [];var rtp_vid_senders = [];
    var video_states = {
        None: 0,
        Camera: 1,
        ScreenShare:2
    ...
    async function updateMediaSenders(track,rtp_senders)
    {
        ...
        {
            if(connection_status(peers_connections[con_id]))
            {
                if(rtp_senders[con_id] && rtp_senders[con_id].track)
                {
                    rtp_senders[con_id].replaceTrack(track);
                }else{
                    rtp_senders[con_id] = peers_connections[con_id].addTrack(track);
                }
            }
        }
    }
    ...
    {
        for (var con_id in peers_connection_ids) {
            if (rtp_senders[con_id] && connection_status(peers_connections[con_id])) {
                peers_connections[con_id].removeTrack(rtp_senders[con_id]);
    ...
    {
        //Process to take remote users IP address
        ...
        peers_connections[connid] = connection;
...
var MyApp = (function(){
    ...
    function event_process_for_signaling_server()
    {
        ...
        socket.on("inform_me_about_others",(other_users)=>{
